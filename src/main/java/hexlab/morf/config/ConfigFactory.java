...
import hexlab.morf.config.impl.ConfigImpl;
import hexlab.morf.config.impl.Parseable;
...
public final class ConfigFactory {
     ...
     * {@link #parseFileAnySyntax(java.io.File,ConfigParseOptions)} but for classpath
     ...
     * {@link #parseFileAnySyntax(java.io.File,ConfigParseOptions) parseFileAnySyntax()}
     ...
     * {@link ConfigValueFactory#fromMap(java.util.Map,String)}, except the keys in the
    ...
    /**
     * See the other overload of {@link #parseMap(java.util.Map, String)} for details,
