...
public interface Config extends ConfigMergeable {
     ...
     * spec</a>.
     *
     * @deprecated  As of release 1.1, replaced by {@link #getDuration(String, java.util.concurrent.TimeUnit)}
     *
     * @param path
     *            path expression
     ...
     * {@link #getDuration(String, java.util.concurrent.TimeUnit)}.
     *
     * @deprecated  As of release 1.1, replaced by {@link #getDuration(String, java.util.concurrent.TimeUnit)}
     *
     * @param path
    ...
    /**
     * @deprecated  As of release 1.1, replaced by {@link #getDurationList(String, java.util.concurrent.TimeUnit)}
     */
     ...
     * same rules as {@link #getDuration(String, java.util.concurrent.TimeUnit)}.
     * 
     * @since 1.2.0
     * @param path
     *            a path expression
